...
namespace Task2._1._2
{
    class Ring:Circle
    {
        ...
        public Ring(Point center, int r, int r2):base(center,r)
        {
            //Circle circle1 = new Circle(x, y, r);
            Circle circle2 = new Circle(center, r2);
        }
        ...
        {
            return base.ToString().Remove(7,base.ToString().Length-7)+ center.X + ";" + center.Y + "), outer radius=" + r + ", inner radius=" + r2;
        }
    }
}
